...
define('SECRET_SALT','Agh0ietheiyahteiPh1ahj');
...
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','10.142.0.4');
define('DBNAME','silph-ticket');
define('DBUSER','silph-camp');
define('DBPASS','shai2mom7Pi!');

# Table prefix
define('TABLE_PREFIX','support_');
